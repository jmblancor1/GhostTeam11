...
Scenario: Acceder a las configuraciones de ghost (metadatos)
    ...
    And I enter text at "meta-title" with data a-priori
    And I wait for 1 seconds
...
Scenario: Personalizar los datos estructurados de un sitio para Twitter
    ...
    And I enter text at "twitter-title" with data a-priori
    And I wait for 1 seconds
    And I click "save-settings"
    And I wait for 1 seconds
    Then I reload the page
...
Scenario: Personalizar los datos estructurados de un sitio para Facebook
    ...
    And I enter text at "facebook-title" with data a-priori
    And I wait for 1 seconds
    And I click "save-settings"
    And I wait for 1 seconds
    Then I reload the page
...
Scenario: Vincular cuentas de redes sociales con datos incorrectos
    ...
    And I enter text at "social-facebook-page" with data a-priori
    And I clear text at "social-twitter-profile"
    And I enter text at "social-twitter-profile" with data a-priori
    Then I click "social-accounts-title"
...
Scenario: Vincular cuentas de redes sociales con datos correctos
    ...
    And I wait for 1 seconds
    And I clear text at "social-facebook-page"
    And I enter text at "social-facebook-page" with data a-priori and url
    And I clear text at "social-twitter-profile"
    And I enter text at "social-twitter-profile" with data a-priori and url
    And I click "save-settings"
    Then I reload the page
    And I click "social-accounts"
    And I wait for 1 seconds
